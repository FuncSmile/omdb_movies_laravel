...
* @route '/my-favorites'
*/
const Controller6b6f90ddab561a49497abaf4d0831907 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller6b6f90ddab561a49497abaf4d0831907.url(options),
    method: 'get',
})

Controller6b6f90ddab561a49497abaf4d0831907.definition = {
    methods: ["get","head"],
    url: '/my-favorites',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/my-favorites'
*/
Controller6b6f90ddab561a49497abaf4d0831907.url = (options?: RouteQueryOptions) => {
    return Controller6b6f90ddab561a49497abaf4d0831907.definition.url + queryParams(options)
}
...
* @route '/my-favorites'
*/
Controller6b6f90ddab561a49497abaf4d0831907.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller6b6f90ddab561a49497abaf4d0831907.url(options),
    method: 'get',
})
...
* @route '/my-favorites'
*/
Controller6b6f90ddab561a49497abaf4d0831907.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller6b6f90ddab561a49497abaf4d0831907.url(options),
    method: 'head',
})
...
const Controller = {
    ...
    '/my-favorites': Controller6b6f90ddab561a49497abaf4d0831907,
